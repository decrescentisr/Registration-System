<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmEditPersonnel.aspx.cs" Inherits="Annual_Salary_Cost_Calculator.frmEditPersonnel" %>
...
<body>
    ...
    <div>
        ...
        <asp:ImageButton ID="ImageButton1" runat="server" DescriptionUrl="~/frmMain.aspx" ImageUrl="~/Images/CIS407A_iLab_ACITLogo.jpg" PostBackUrl="~/frmMain.aspx" />
        <br />
        <br />
        <br />
